...
class TestCase(unittest.TestCase):
    ...
    def test_fizzbuzz2(self):
        self.assertEqual(fizzbuzz.fun(98), 98) #Should pass the test as 15 is divisible by 3 and 5

    def test_fizzbuzz3(self):
        self.assertEqual(fizzbuzz.fun(6), "Fizz") #Should pass the test as 15 is divisible by 3 and 5

    def test_fizzbuzz4(self):
        self.assertEqual(fizzbuzz.fun(10), "Buzz") #Should pass the test as 15 is divisible by 3 and 5
